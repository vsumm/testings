...
$font_data    = Kata_Plus_Pro_FontsManager_Helpers::get_font_data( 'font-squirrel', $current_font['name'] );
?>
...
<form method="post" class="wrap kata-plus-fonts-manager-wrap kata-plus-fonts-manager-wrap kata-plus-fonts-manager-add-new-wrap">
	...
	<input type="hidden" value="<?php echo $current_font['url']; ?>" name="url">
	...
	<h1 class="wp-heading-inline">
		...
		<span class="dashicons dashicons-arrow-right-alt2"></span>
		<span><?php echo $current_font['name']; ?></span>
	</h1>

	<div class="kata-plus-fonts-manager-wrap kata-plus-fonts-manager-add-new-font-squirrel-wrap">
		<div class="col col-3">
						...
						<div class="postbox">
							...
							foreach ( $font_data as $font ) {
								if ( $font['listing_image'] ) {
									echo '<div class="preview-entry"><img src="' . $font['listing_image'] . '"><span>' . $font['style_name'] . '</span></div>';
								}
							}
							?>
				...
				<div id="postbox-container" class="postbox-container">
					<div class="meta-box-sortables ui-sortable" id="normal-sortables">
						<div class="postbox">
							...
							foreach ( $font_data as $font ) {
								$checked = '';
								if ( is_array( $variants ) && in_array( $font['style_name'], $variants ) ) {
									$checked = 'checked="checked" ';
								}
								echo '<label><input type="checkbox" ' . $checked . 'name="variants[]" value="' . $font['style_name'] . '">' . $font['style_name'] . '</label>';
							}
							?>
							</div>
						</div>
