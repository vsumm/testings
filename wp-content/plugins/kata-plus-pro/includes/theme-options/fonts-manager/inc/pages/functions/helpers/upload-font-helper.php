...
if (!class_exists('Kata_plus_FontsManager_Add_New_Font_Upload_Font_Helper')) :
	/**
	 * Kata_plus_FontsManager_Add_New_Font_Upload_Font_Helper.
	 *
	 * @author   ClimaxThemes
	 * @package  Kata Plus
	 * @since    1.0.0
	 */
	class Kata_plus_FontsManager_Add_New_Font_Upload_Font_Helper
	{
		 ...
		 * @since     1.0.0
		 * @access     private
		 * @var     Kata_plus_FontsManager_Add_New_Font_Upload_Font_Helper
		 */
			...
			$plupload_init = array(
				...
				'filters'             => array(
					array(
						...
						'extensions' => 'otf,ttf,eot,woff,woff2',
					),
				),
				'multipart'           => true,
				...
				'multipart_params'    => array(
					...
					'action'      => 'kata_plus_pro_fonts_manager_fonts_upload',            // the ajax action name
				),
			);
...
<?php
				...
				$(".font-file-entry").each(function() {
					...
					$widgetContainer.find(".kata-add-media-upload").off().on("click", function (e) {
						...
						frame.on("select", function () {
							...
							console.log($widgetContainer.find("input"));
	...
	Kata_plus_FontsManager_Add_New_Font_Upload_Font_Helper::get_instance();
endif;
