...
<form method="post" class="wrap kata-plus-fonts-manager-wrap kata-plus-fonts-manager-wrap kata-plus-fonts-manager-add-new-wrap" id="dashboard-widgets">
	...
	<div class="kata-plus-action-box typekit">
		<div>
			<input type="text" class="kata-plus-search-box" name="url" id="kata_plus_pro_fonts_manager_typekit_id_box" placeholder="<?php echo esc_attr__( 'Typekit ID or Stylesheet URL ', 'kata-plus' ); ?>">
			<div class="ti-help-alt">
				<span>
				<img src="<?php echo Kata_Plus::$assets . 'images/fonts-manager/typekit-info.png'; ?>" alt="Info">
					After choosing your desired font on Adobe Fonts website, click on “Add to Web Project” button and after entering the kit name (web project) click on “Create” button and then an HTML code appears as shown in the image above. Now, you can copy the Typekit ID or URL from the code.
				</span>
			</div>
		</div>
		<div>
