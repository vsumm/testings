...
<form method="post" class="wrap kata-plus-fonts-manager-wrap kata-plus-fonts-manager-wrap kata-plus-fonts-manager-add-new-wrap" id="dashboard-widgets">
	...
	<div class="kata-plus-action-box custom-font">
		<div>
			<input type="text" class="kata-plus-search-box" name="url" value="<?php echo $current_font['url']; ?>" id="kata_plus_pro_fonts_manager_custom_font_id_box" placeholder="<?php echo esc_attr__('Put you`r Fonts CSS URL here', 'kata-plus'); ?>">
		</div>
		<div>
...
<script>
	jQuery(document).ready(function() {
		...
		setTimeout(function() {
			jQuery('#kata_plus_pro_fonts_manager_custom_font_id_box').trigger('input');
		}, 500);
	});
</script>