...
/**
 * Kata Plus Pro Template Library Source call to action Class.
 *
 * @author  ClimaxThemes
...
class KataPlus_Template_Library_Source_Call_To_Action extends \Elementor\TemplateLibrary\Source_Base {
	...
	public function get_title() {
		return __( 'Call To Action', 'kata-plus' );
	}
	...
	public function get_items( $args = [] ) {
		...
		foreach ($data as $template) {
			if ($template['subtype'] != 'calltoaction') {
				continue;
			}
