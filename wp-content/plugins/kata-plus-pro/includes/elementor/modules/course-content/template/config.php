...
class Kata_Plus_Pro_Course_Content extends Widget_Base {
	public function get_name() {
		return 'kata-plus-course-content';
	}

	public function get_title() {
		return esc_html__( 'Course Content', 'kata-plus' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => 'kata_styler',
				'selectors' => Kata_Styler::selectors( '.kata-course-content' ),
			]
		);
		$this->add_control(
			'styler_h1',
		...
		$this->add_control(
			...
			[
				...
				'type'      => 'kata_styler',
				'selectors' => Kata_Styler::selectors(  '.elementor-widget-container blockquote p' ),
			]
		);
		$this->add_control(
