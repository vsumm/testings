...
class Kata_Plus_Pro_Author_Page_Widget {
	/**
	 * Constructor.
	 *
	 * @since   1.0.0
	...
	private function register_widget() {
		Plugin::instance()->widgets_manager->register_widget_type( new Kata_Plus_Pro_Author_Page() );
	}
...
new Kata_Plus_Pro_Author_Page_Widget();
