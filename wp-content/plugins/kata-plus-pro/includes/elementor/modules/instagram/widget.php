...
class Kata_Plus_Pro_Instagram_Widget {
	/**
	 * Constructor.
	 *
	 * @since   1.0.0
	...
	private function dependencies() {
		Kata_Plus_Pro_Autoloader::load( dirname( __FILE__ ), 'class.instagram.api' );
	...
	private function register_widget() {
		Plugin::instance()->widgets_manager->register_widget_type( new Kata_Plus_Pro_Instagram() );
	}
	...
	public function frontend_styles() {
		...
		wp_register_style( 'kata-plus-instagram', Kata_Plus::$assets . 'css/frontend/instagram.css', [], Kata_Plus_Pro::$version );
	}
	...
	public function preview_styles() {
		...
		wp_enqueue_style( 'kata-plus-instagram', Kata_Plus::$assets . 'css/frontend/instagram.css', [], Kata_Plus_Pro::$version );
	}
}

new Kata_Plus_Pro_Instagram_Widget();
