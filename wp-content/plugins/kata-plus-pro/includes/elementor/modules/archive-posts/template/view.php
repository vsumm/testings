...
$tax_query   = '';
if ( ! Kata_Plus_Pro_Elementor::is_edit_mode() && $queried_obj ) {
	$tax_query = array(
		array(
...
$post_type = Plugin::$instance->editor->is_edit_mode() ? 'post' : get_post_type();
...
if ( $settings['enable_carousel'] ) {
	?>
	<div
	class="kata-blog-posts row <?php echo esc_attr( $carousel_classes ); ?>"
