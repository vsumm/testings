...
if ( ! class_exists( 'Kata_Plus_Pro_Archive_Posts' ) ) {
	class Kata_Plus_Pro_Archive_Posts extends Widget_Base {
		public function get_name() {
			return 'kata-plus-archive-posts';
		}

		public function get_title() {
			return esc_html__( 'Posts Archive', 'kata-plus' );
		}

		public function get_icon() {
			return 'kata-widget kata-eicon-archive-posts';
		}
