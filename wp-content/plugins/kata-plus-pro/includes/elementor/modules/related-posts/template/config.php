...
if ( ! class_exists( 'Kata_Plus_Pro_Related_Posts' ) ) {
	class Kata_Plus_Pro_Related_Posts extends Widget_Base {
		public function get_name() {
			return 'kata-plus-related-posts';
		}

		public function get_title() {
			return esc_html__( 'Related Posts', 'kata-plus' );
		}

		public function get_icon() {
			return 'kata-widget kata-eicon-related-posts';
		}
		...
		public function get_script_depends() {
			return [ 'kata-plus-owl-carousel-js', 'kata-plus-owl', 'zilla-likes', 'kata-blog-posts' ];
		}
			...
			$this->add_control(
				...
				[
					...
					'options' => [
						...
						'most_liked'	=> esc_html__( 'Most Liked', 'kata-plus' ),
						'most_viewed'	=> esc_html__( 'Most Viewed', 'kata-plus' ),
					],
				]
			);
			$this->add_control(
