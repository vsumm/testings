...
if ( ! class_exists( 'Kata_Plus_Pro_Search_Page' ) ) {
	class Kata_Plus_Pro_Search_Page extends Widget_Base {
		public function get_name() {
			return 'kata-plus-search-page';
		}

		public function get_title() {
			return esc_html__( 'Search Page', 'kata-plus' );
		}
		...
		protected function register_controls() {
			...
			$this->add_control(
				'notfound',
				[
					'label' => __( 'Not found message', 'kata-plus' ),
					'type' => Controls_Manager::TEXT,
					'default' => __( 'Sorry, But nothing matched your search terms.', 'kata-plus' ),
				]
			);
			$this->add_control(
				'query_order_by',
