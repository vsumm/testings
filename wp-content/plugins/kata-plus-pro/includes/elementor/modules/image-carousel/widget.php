...
class Kata_Plus_Pro_Image_Carousel_Widget {
	/**
	 * Constructor.
	 *
	 * @since   1.0.0
	...
	public function scripts() {
		...
		wp_register_script( 'kata-plus-owlcarousel-thumbs', Kata_Plus::$assets . 'js/libraries/owl.carousel2.thumbs.min.js', [ 'jquery' ], Kata_Plus_Pro::$version, true );
		...
		wp_register_script( 'kata-image-carousel', Kata_Plus::$assets . 'js/frontend/image-carousel.js', [ 'jquery' ], Kata_Plus_Pro::$version, true );
	}
	...
	private function register_widget() {
		Plugin::instance()->widgets_manager->register_widget_type( new Kata_Plus_Pro_Image_Carousel() );
	}
	...
	public function frontend_styles() {
		...
		wp_register_style( 'kata-image-carousel', Kata_Plus::$assets . 'css/frontend/image-carousel.css', [], Kata_Plus_Pro::$version );
	}
	...
	public function preview_styles() {
		...
		wp_enqueue_style( 'kata-image-carousel', Kata_Plus::$assets . 'css/frontend/image-carousel.css', [], Kata_Plus_Pro::$version );
	}

}

new Kata_Plus_Pro_Image_Carousel_Widget();
