...
if (!class_exists('Kata_Plus_Pro_Builders_Base')) {
	class Kata_Plus_Pro_Builders_Base extends \Elementor\Core\Base\Document {
		...
		public function load_the_builder()
		{
			...
			if (isset($_REQUEST['elementor-preview']) && \Elementor\Plugin::$instance->preview->is_preview_mode()) {
				if ( get_the_title() == 'Kata Sticky Header' || get_post_type_object('kata_mega_menu')->labels->singular_name != 'Mega Menu') {
		...
		public function notice()
		{
			...
			if (get_post_status($id) == 'trash') {
				...
				<div id="message" class="error notice is-dismissible">
					<p><?php echo $this->name . ' ' . __('is in the Trash.', 'kata-plus'); ?> <a href="<?php echo esc_url($restore_link); ?>"><?php echo __('Please restore it.', 'kata-plus'); ?></a></p>
