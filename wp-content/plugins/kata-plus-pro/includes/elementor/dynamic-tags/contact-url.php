...
class Kata_Plus_Pro_Contact_URL extends Tag {

	public function get_name() {
		return 'kata-plus-pro-contact-url';
	}

	public function get_title() {
		return __( 'Contact URL', 'kata-plus-pro' );
	}
	...
	protected function _register_controls() {
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'tel' => __( 'Tel', 'kata-plus-pro' ),
					'sms' => __( 'SMS', 'kata-plus-pro' ),
					'whatsapp' => __( 'WhatsApp', 'kata-plus-pro' ),
					'skype' => __( 'Skype', 'kata-plus-pro' ),
					'messenger' => __( 'Messenger', 'kata-plus-pro' ),
					'viber' => __( 'Viber', 'kata-plus-pro' ),
					'waze' => __( 'Waze', 'kata-plus-pro' ),
					'google_calendar' => __( 'Google Calendar', 'kata-plus-pro' ),
					'outlook_calendar' => __( 'Outlook Calendar', 'kata-plus-pro' ),
					'yahoo_calendar' => __( 'Yahoo Calendar', 'kata-plus-pro' ),
				],
			]
		);
		...
		$this->add_control(
			'mail_subject',
			[
				'label' => __( 'Subject', 'kata-plus-pro' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => 'true',
				'condition' => [
					'link_type' => 'email',
		...
		$this->add_control(
			'mail_body',
			[
				'label' => __( 'Message', 'kata-plus-pro' ),
		...
		$this->add_control(
			'username',
			[
				'label' => __( 'Username', 'kata-plus-pro' ),
				'type' => Controls_Manager::TEXT,
				'condition' => [
		...
		$this->add_control(
			'viber_action',
			[
				'label' => __( 'Action', 'kata-plus-pro' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'contact' => __( 'Contact', 'kata-plus-pro' ),
					'add' => __( 'Add', 'kata-plus-pro' ),
				],
				'default' => 'contact',
				'condition' => [
					'link_type' => 'viber',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'call' => __( 'Call', 'kata-plus-pro' ),
					'chat' => __( 'Chat', 'kata-plus-pro' ),
					'userinfo' => __( 'Show Profile', 'kata-plus-pro' ),
					'add' => __( 'Add to Contacts', 'kata-plus-pro' ),
					'voicemail' => __( 'Send Voice Mail', 'kata-plus-pro' ),
				],
				'default' => 'call',
				'condition' => [
					'link_type' => 'skype',
		...
		$this->add_control(
			'waze_address',
			[
				'label' => __( 'Location', 'kata-plus-pro' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => 'true',
				'condition' => [
					'link_type' => 'waze',
		...
		$this->add_control(
			'event_description',
			[
				'label' => __( 'Description', 'kata-plus-pro' ),
				'type' => Controls_Manager::TEXTAREA,
				'condition' => [
					'link_type' => [
						'google_calendar',
