...
if(!function_exists('wp_paint_register_scripts')) {
  function wp_paint_register_scripts() {
    ...
    wp_register_script('wpp_paint_admin_js', WPP_PLUGIN_URL . "/static/js/wp-paint-admin.js", ['media-views', 'wpp_jquery_initialize_js'], WPP_PLUGIN_VERSION_HASH);
    wp_register_style('wpp_paint_admin_css', WPP_PLUGIN_URL . "/static/css/wp-paint-admin.css", [], WPP_PLUGIN_VERSION_HASH);

    wp_register_script('wpp_pace_js', WPP_PLUGIN_URL . "/static/libs/pace/pace.js", ['jquery'], WPP_PLUGIN_VERSION_HASH);
    wp_register_script('wpp_glfx_js', WPP_PLUGIN_URL . "/static/libs/glfx/glfx.js", ['jquery'], WPP_PLUGIN_VERSION_HASH);
    wp_register_script('wpp_jquery_blockui_js', WPP_PLUGIN_URL . "/static/js/jquery.blockUI.js", ['jquery'], WPP_PLUGIN_VERSION_HASH);
    wp_register_script('wpp_mini_paint_js', WPP_PLUGIN_URL . "/static/libs/mini-paint/mini-paint.js", ['jquery'], WPP_PLUGIN_VERSION_HASH);
    wp_register_script('wpp_paint_box_js', WPP_PLUGIN_URL . "/static/js/wp-paint-box.js", ['wpp_pace_js', 'wpp_glfx_js', 'wpp_jquery_blockui_js', 'wpp_mini_paint_js'], WPP_PLUGIN_VERSION_HASH);
    wp_register_style('wpp_pace_css', WPP_PLUGIN_URL . "/static/libs/pace/pace.css", [], WPP_PLUGIN_VERSION_HASH);
    wp_register_style('wpp_mini_paint_css', WPP_PLUGIN_URL . "/static/libs/mini-paint/mini-paint.css", [], WPP_PLUGIN_VERSION_HASH);
    wp_register_style('wpp_paint_box_css', WPP_PLUGIN_URL . "/static/css/wp-paint-box.css", ['wpp_pace_css', 'wpp_mini_paint_css'], WPP_PLUGIN_VERSION_HASH);
  }
