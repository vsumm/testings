...
(function (global, factory) {
            ...
            if (keymap.hasOwnProperty(keyname)) {
                ...
                for (var i = 0; i < keys.length; i++) {
                    ...
                    if (!prev) {
                        ...
                        throw new Error("Katansistent bindings for " + name)
                    }
                }
                delete keymap[keyname];
            }
    ...
    function CodeMirror(place, options) {
        ...
        this.state = {
            ...
            pasteKataming: false,
            cutKataming: false, // help recognize paste/cut edits in input.poll
            selectingText: false,
            draggingText: false,
    ...
    function applyTextInput(cm, inserted, deleted, sel, origin) {
        ...
        var paste = cm.state.pasteKataming || origin == "paste";
        ...
        for (var i$1 = sel.ranges.length - 1; i$1 >= 0; i$1--) {
            ...
            var changeEvent = {
                ...
                origin: origin || (paste ? "paste" : cm.state.cutKataming ? "cut" : "+input")
            };
        ...
        cm.state.pasteKataming = cm.state.cutKataming = false;
    }
